...
import {updatePerfume} from '../../../redux/thunks/admin-thunks'
...
const EditPerfume: FC<RouteComponentProps<{id: string}>> = ({match}) => {
    ...
    const perfumeUpdated: boolean = useSelector((state: AppStateType) => state.admin.isPerfumeUpdated);
    ...
    useEffect(() => {
        dispatch(fetchPerfume(perfumeId));
    }, [])
    ...
    useEffect(() => {
        ...
        if (perfumeUpdated) {
            ...
            window.scrollTo(0, 0);
            dispatch(fetchPerfumeByQuery(perfumeId));
        }
    }, [perfumeData]);
    ...
    const handleInputChange = (event: ChangeEvent<HTMLInputElement> | ChangeEvent<HTMLSelectElement>): void => {
        ...
        console.log("prev perfume: ", perfume);
        setPerfume(prev => ({...prev, [name]: value}));
        // console.log("after perfume: ", perfume);
    ...
    // console.log("perfumeEdit: ", perfume);
    return (
        <div>
            <Toasts showToast={showToast} message={"Update perfume successfull"} />
            <div className="container">
                ...
                <form onSubmit={onFormSubmit}>
                    <div className="row mt-5">
                        ...
                        <div className="col-md-6">
                            <img src={filename} style={{width: "200px"}}/>
                            <br />
